...
function typeAPR({ title, subtitle, partnerLogo }) {
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="color:#034638;">
      ...
      ${subtitle ? `<div style="position:absolute;left:82px;top:543px;z-index:5;font-weight:500;font-size:44px;color:#7b9690;">${subtitle}</div>` : ''}

      <!-- Title: Figma x=82 y=586, 112px, weight 250, max-width 810px -->
      <div id="title-container" style="position:absolute;left:82px;top:616px;width:810px;height:272px;z-index:5;">
...
function typeE({ dateRange, cryptoIcons = [], theme = 'light' }) {
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="background:#f5fffd;color:${textColor};">
      ...
      <div style="position:absolute;left:56px;top:553px;z-index:5;max-width:654px;">
...
function template5({ title, subtitle, partnerLogo }) {
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="background:#f5fffd;color:#034638;">
      ...
      ${subtitle ? `<div style="position:absolute;left:56px;top:610px;z-index:5;font-weight:500;font-size:20px;letter-spacing:0.1em;text-transform:uppercase;">${subtitle}</div>` : ''}

      <!-- Title: x=56 y=644, 96px w200, max-width 700px with auto-fit -->
      <div id="title-container" style="position:absolute;left:56px;top:674px;width:700px;height:220px;z-index:5;">
...
function template6({ title, subtitle, partnerLogo }) {
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="background:#f5fffd;color:#034638;">
      ...
      ${subtitle ? `<div style="position:absolute;left:856px;top:551px;z-index:5;font-weight:500;font-size:20px;letter-spacing:0.1em;text-transform:uppercase;">${subtitle}</div>` : ''}

      <!-- Title: x=856 y=577, 86px w200, max-width 688px with auto-fit -->
      <div id="title-container" style="position:absolute;left:856px;top:607px;width:688px;height:280px;z-index:5;">
...
function template7({ title, subtitle, partnerLogo }) {
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="background:#f5fffd;">
      ...
      ${subtitle ? `<div style="position:absolute;left:48px;top:524px;z-index:5;font-weight:500;font-size:28px;color:#f5fffd;">${subtitle}</div>` : ''}

      <!-- Title: x=48 y=560, 140px w250, white, auto-fit -->
      <div id="title-container" style="position:absolute;left:48px;top:590px;width:700px;height:300px;z-index:5;">
...
function template8({ title, subtitle, partnerLogo }) {
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="background:#f5fffd;color:#034638;">
      ...
      <!-- Subtitle -->
      ${subtitle ? `<div style="position:absolute;left:48px;top:560px;z-index:5;font-weight:500;font-size:20px;letter-spacing:0.1em;text-transform:uppercase;">${subtitle}</div>` : ''}

      <!-- Title: x=48 y=576, 88px, auto-fit -->
      <div id="title-container" style="position:absolute;left:48px;top:606px;width:704px;height:280px;z-index:5;">
...
function template10({ title, partnerLogo }) {
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="color:#f5fffd;">
      ...
      <div id="title-container" style="position:absolute;left:82px;top:574px;width:663px;height:274px;z-index:5;">
...
function template11({ title, subtitle, partnerLogo1, partnerLogo2, partnerLogo3 }) {
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="color:#034638;">
      ...
      <div id="title-container" style="position:absolute;left:82px;top:508px;width:810px;height:267px;z-index:5;">
        <div id="title" style="font-weight:200;font-size:86px;line-height:1.08;">${title}</div>
      </div>

      <!-- Subtitle: x=82 y=769, 44px, #7b9690 -->
      ${subtitle ? `<div style="position:absolute;left:82px;top:799px;z-index:5;font-weight:500;font-size:44px;color:#7b9690;">${subtitle}</div>` : ''}
...
function template13({ title, subtitle, partnerLogo, cryptoIcon }) {
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="color:#034638;">
      ...
      ${subtitle ? `<div style="position:absolute;left:82px;top:498px;z-index:5;font-weight:500;font-size:22px;letter-spacing:0.05em;">${subtitle}</div>` : ''}

      <!-- Title: x=82 y=518, 96px, auto-fit -->
      <div id="title-container" style="position:absolute;left:82px;top:548px;width:654px;height:300px;z-index:5;">
        <div id="title" style="font-weight:200;font-size:96px;line-height:1.04;">${title}</div>
      </div>
...
function template14({ title, subtitle, partnerLogo }) {
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="color:#f5fffd;">
      ...
      ${subtitle ? `<div style="position:absolute;left:855px;top:500px;z-index:5;font-weight:500;font-size:20px;letter-spacing:0.1em;text-transform:uppercase;">${subtitle}</div>` : ''}

      <!-- Title: x=855 y=526, 96px, auto-fit -->
      <div id="title-container" style="position:absolute;left:855px;top:556px;width:655px;height:300px;z-index:5;">
        <div id="title" style="font-weight:200;font-size:96px;line-height:1.04;">${title}</div>
      </div>
    </div>
  </body></html>`;
...
function template15({ title, subtitle, partnerLogo }) {
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="color:#f5fffd;">
      ...
      <div id="title-container" style="position:absolute;left:82px;top:523px;width:663px;height:258px;z-index:5;">
        <div id="title" style="font-weight:200;font-size:83px;line-height:1.04;">${title}</div>
      </div>

      <!-- Subtitle: x=82 y=775, 38px, #7b9690 -->
      ${subtitle ? `<div style="position:absolute;left:82px;top:805px;z-index:5;font-weight:500;font-size:38px;color:#7b9690;">${subtitle}</div>` : ''}
...
function template16({ title, partnerLogo, cryptoIcon }) {
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="color:#f5fffd;">
      ...
      <div id="title-container" style="position:absolute;left:855px;top:560px;width:647px;height:288px;z-index:5;">
...
// Filters out files that are templates' background/decoration assets, not
// brand logos (anything starting with `bg-`, `pattern-`, or the week-icons
// sprite, plus everstake's own marks).
function listLogos() {
