  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="color:${textColor};">
      ...
      <div id="title-container" style="position:absolute;left:262px;top:262px;width:1076px;height:376px;z-index:5;display:flex;flex-direction:column;align-items:center;justify-content:center;">
        ...
        <div id="title" style="font-weight:200;font-size:111px;line-height:1.04;text-align:center;word-break:break-word;overflow-wrap:anywhere;">${title}</div>
      </div>
    </div>
  </body></html>`;
}
...
function typeAPR({ title, subtitle, partnerLogo }) {
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="color:#034638;">
      ...
      <!-- Subtitle + title: bottom-aligned flex container.
           Original: subtitle y=513 (44px), title y=586 height=272 → bottom y=858.
           New container: y=513..858. -->
      <div id="title-container" style="position:absolute;left:82px;top:513px;width:810px;height:345px;z-index:5;display:flex;flex-direction:column;justify-content:flex-end;">
        ${subtitle ? `<div style="font-weight:500;font-size:44px;color:#7b9690;margin-bottom:20px;">${subtitle}</div>` : ''}
        <div id="title" style="font-weight:200;font-size:112px;line-height:1.04;color:#034638;word-break:break-word;overflow-wrap:anywhere;">${title}</div>
      </div>
...
function template5({ title, subtitle, partnerLogo }) {
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="background:#f5fffd;color:#034638;">
      ...
      <!-- Subtitle + title share a flex container so subtitle sits
           just above the title, bottom-aligned. Original positions:
           subtitle y=580, title y=644 height=220 → bottom edge y=864.
           New container spans y=580..864. -->
      <div id="title-container" style="position:absolute;left:56px;top:580px;width:700px;height:284px;z-index:5;display:flex;flex-direction:column;justify-content:flex-end;">
        ${subtitle ? `<div style="font-weight:500;font-size:20px;letter-spacing:0.1em;text-transform:uppercase;margin-bottom:20px;">${subtitle}</div>` : ''}
        <div id="title" style="font-weight:200;font-size:96px;line-height:1.04;word-break:break-word;overflow-wrap:anywhere;">${title}</div>
      </div>
...
function template6({ title, subtitle, partnerLogo }) {
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="background:#f5fffd;color:#034638;">
      ...
      <!-- Subtitle + title: bottom-aligned flex container.
           Original: subtitle y=521, title y=577 height=280 → bottom y=857.
           New container: y=521..857. -->
      <div id="title-container" style="position:absolute;left:856px;top:521px;width:688px;height:336px;z-index:5;display:flex;flex-direction:column;justify-content:flex-end;">
        ${subtitle ? `<div style="font-weight:500;font-size:20px;letter-spacing:0.1em;text-transform:uppercase;margin-bottom:20px;">${subtitle}</div>` : ''}
        <div id="title" style="font-weight:200;font-size:86px;line-height:1.08;word-break:break-word;overflow-wrap:anywhere;">${title}</div>
      </div>
    </div>
  </body></html>`;
}
...
function template7({ title, subtitle, partnerLogo }) {
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="background:#f5fffd;">
      ...
      <!-- Subtitle + title: bottom-aligned flex container.
           Original: subtitle y=494, title y=560 height=300 → bottom y=860.
           New container: y=494..860. -->
      <div id="title-container" style="position:absolute;left:48px;top:494px;width:700px;height:366px;z-index:5;display:flex;flex-direction:column;justify-content:flex-end;">
        ${subtitle ? `<div style="font-weight:500;font-size:28px;color:#f5fffd;margin-bottom:24px;">${subtitle}</div>` : ''}
        <div id="title" style="font-weight:200;font-size:140px;line-height:1.04;color:#f5fffd;word-break:break-word;overflow-wrap:anywhere;">${title}</div>
      </div>
...
function template8({ title, subtitle, partnerLogo }) {
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="background:#f5fffd;color:#034638;">
      ...
      <!-- Subtitle + title: bottom-aligned flex container.
           Original: subtitle y=530, title y=576 height=280 → bottom y=856.
           New container: y=530..856. -->
      <div id="title-container" style="position:absolute;left:48px;top:530px;width:704px;height:326px;z-index:5;display:flex;flex-direction:column;justify-content:flex-end;">
        ${subtitle ? `<div style="font-weight:500;font-size:20px;letter-spacing:0.1em;text-transform:uppercase;margin-bottom:20px;">${subtitle}</div>` : ''}
        <div id="title" style="font-weight:200;font-size:88px;line-height:1.04;word-break:break-word;overflow-wrap:anywhere;">${title}</div>
      </div>
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="color:#034638;">
      ...
      <div id="title-container" style="position:absolute;left:316px;top:393px;width:968px;height:340px;z-index:5;display:flex;align-items:center;justify-content:center;">
        <div id="title" style="font-weight:200;font-size:88px;line-height:1.04;text-align:center;word-break:break-word;overflow-wrap:anywhere;">${title}</div>
      </div>
    </div>
  </body></html>`;
}
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="color:#f5fffd;">
      ...
      <div id="title-container" style="position:absolute;left:82px;top:544px;width:663px;height:274px;z-index:5;display:flex;flex-direction:column;justify-content:flex-end;">
        <div id="title" style="font-weight:200;font-size:132px;line-height:1.04;word-break:break-word;overflow-wrap:anywhere;">${title}</div>
      </div>
...
function template13({ title, subtitle, partnerLogo, cryptoIcon }) {
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="color:#034638;">
      ...
      <!-- Subtitle + title: bottom-aligned flex container.
           Original: subtitle y=468, title y=518 height=300 → bottom y=818.
           New container: y=468..818. -->
      <div id="title-container" style="position:absolute;left:82px;top:468px;width:654px;height:350px;z-index:5;display:flex;flex-direction:column;justify-content:flex-end;">
        ${subtitle ? `<div style="font-weight:500;font-size:22px;letter-spacing:0.05em;margin-bottom:20px;">${subtitle}</div>` : ''}
        <div id="title" style="font-weight:200;font-size:96px;line-height:1.04;word-break:break-word;overflow-wrap:anywhere;">${title}</div>
      </div>
...
function template14({ title, subtitle, partnerLogo }) {
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="color:#f5fffd;">
      ...
      <!-- Subtitle + title: bottom-aligned flex container.
           Original: subtitle y=470, title y=526 height=300 → bottom y=826.
           New container: y=470..826. -->
      <div id="title-container" style="position:absolute;left:855px;top:470px;width:655px;height:356px;z-index:5;display:flex;flex-direction:column;justify-content:flex-end;">
        ${subtitle ? `<div style="font-weight:500;font-size:20px;letter-spacing:0.1em;text-transform:uppercase;margin-bottom:20px;">${subtitle}</div>` : ''}
        <div id="title" style="font-weight:200;font-size:96px;line-height:1.04;word-break:break-word;overflow-wrap:anywhere;">${title}</div>
      </div>
    </div>
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="color:#f5fffd;">
      ...
      <div id="title-container" style="position:absolute;left:82px;top:493px;width:663px;height:258px;z-index:5;display:flex;flex-direction:column;justify-content:flex-end;">
        <div id="title" style="font-weight:200;font-size:83px;line-height:1.04;word-break:break-word;overflow-wrap:anywhere;">${title}</div>
      </div>
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner" style="color:#f5fffd;">
      ...
      <div id="title-container" style="position:absolute;left:855px;top:530px;width:647px;height:288px;z-index:5;display:flex;flex-direction:column;justify-content:flex-end;">
        <div id="title" style="font-weight:200;font-size:92px;line-height:1.04;word-break:break-word;overflow-wrap:anywhere;">${title}</div>
      </div>
    </div>
  </body></html>`;
}
...
function template18({ title, subtitle, partnerLogo1, partnerLogo2 }) {
  ...
  return `<!DOCTYPE html><html><head><style>
    ...
    <div class="banner">
      ...
      <!-- Subtitle and title share a flex container so they sit
           together near the bottom (subtitle just above title) -->
      <div id="title-container" style="position:absolute;left:48px;top:448px;width:884px;height:400px;z-index:5;display:flex;flex-direction:column;justify-content:flex-end;">
        ${subtitle ? `<div style="font-weight:500;font-size:40px;color:#7b9690;margin-bottom:24px;">${subtitle}</div>` : ''}
        <div id="title" style="font-weight:200;font-size:96px;line-height:1.04;color:#f5fffd;word-break:break-word;overflow-wrap:anywhere;">${title}</div>
      </div>
...
// Logo category map. Two kinds:
//   • 'full'     — has wordmark / brand text (e.g. "Aptos" written next
//                  to the icon). Suitable for templates with a wide
//                  panel where the wordmark fits comfortably.
//   • 'logomark' — icon / symbol only, no text. Suitable for templates
//                  with small circular slots (APR badge, 2-3 collab
//                  layouts) where text would be unreadable.
//
// Anything not listed defaults to 'logomark' (the safer choice when
// uncertain — a wordmark squeezed into a logomark slot looks much
// worse than a logomark in a wordmark slot).
const LOGO_CATEGORY = {
  // Wordmark / full-brand logos
  'aptos-full.svg':         'full',
  'doublezero.svg':         'full',
  'ethereum-full.svg':      'full',
  'neo-full.svg':           'full',
  'partner-horizontal.svg': 'full',
  'satsterminal.svg':       'full',
  'solana-full.svg':        'full',
  'trezor.svg':             'full',
  'trezor-white.svg':       'full',

  // Icon-only logomarks
  'aptos.png':              'logomark',
  'cardano.svg':            'logomark',
  'celestia.svg':           'logomark',
  'collab2-logo1.svg':      'logomark',
  'collab3-logo1.svg':      'logomark',
  'collab3-logo2.svg':      'logomark',
  'collab3-logo3.svg':      'logomark',
  'icon-network.svg':       'logomark',
  'injective.svg':          'logomark',
  'monad.svg':              'logomark',
  'solana.png':             'logomark',
  'sui.png':                'logomark',
  't18-logo1.svg':          'logomark',
};

function getLogoCategory(filename) {
  return LOGO_CATEGORY[filename] || 'logomark';
}

// Logo *kind* — orthogonal to category. Where `LOGO_CATEGORY` describes the
// visual form factor (wordmark vs icon), `LOGO_KIND` describes what the logo
// represents:
//   • 'token'   — a blockchain / token / network (Aptos, Solana, Monad, ...)
//   • 'company' — a partner company or product brand (Trezor, SatsTerminal,
//                 generic collaboration placeholders, ...)
//
// Used to restrict the picker on templates whose layout is semantically tied
// to one or the other (e.g. APR + Dark Full show only token logos, while the
// Collaboration 3 Companies layouts show only company logos).
//
// Unlisted files fall through `getLogoKind` as `null` (no kind filter applies
// — they remain visible in pickers that don't restrict by kind).
const LOGO_KIND = {
  // Tokens / networks
  'aptos-full.svg':         'token',
  'aptos.png':              'token',
  'cardano.svg':            'token',
  'celestia.svg':           'token',
  'doublezero.svg':         'token',
  'ethereum-full.svg':      'token',
  'icon-network.svg':       'token',
  'injective.svg':          'token',
  'monad.svg':              'token',
  'neo-full.svg':           'token',
  'solana-full.svg':        'token',
  'solana.png':             'token',
  'sui.png':                'token',

  // Companies / partner brands
  'collab2-logo1.svg':      'company',
  'collab3-logo1.svg':      'company',
  'collab3-logo2.svg':      'company',
  'collab3-logo3.svg':      'company',
  'partner-horizontal.svg': 'company',
  'satsterminal.svg':       'company',
  't18-logo1.svg':          'company',
  'trezor.svg':             'company',
  'trezor-white.svg':       'company',
};

function getLogoKind(filename) {
  return LOGO_KIND[filename] || null;
}

// List available partner logos, optionally filtered by category and/or kind.
//   listLogos()                       → every logo
//   listLogos('full')                 → only wordmark logos (any kind)
//   listLogos('logomark')             → only logomarks (any kind)
//   listLogos('all', 'token')         → only token logos (any category)
//   listLogos('logomark', 'company')  → company-kind logomarks
//
// Both filters compose with AND. Use 'all' / null to skip a dimension.
//
// Filters out background/decoration assets that aren't actual brand
// logos (`bg-*`, `pattern-*`, `week-icons*`, and Everstake's own marks).
function listLogos(category, kind) {
  const files = fs.readdirSync(LOGOS_DIR);
  const NON_LOGO = /^(bg-|pattern-|everstake-|week-icons)/i;
  let result = files.filter(
    f => !NON_LOGO.test(f) && /\.(png|jpg|jpeg|svg|webp)$/i.test(f)
  );
  if (category && category !== 'all') {
    result = result.filter(f => getLogoCategory(f) === category);
  }
  if (kind && kind !== 'all') {
    result = result.filter(f => getLogoKind(f) === kind);
  }
  return result;
}

module.exports = { TEMPLATES, listLogos };
