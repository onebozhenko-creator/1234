 ...
 *
 * `logoType` controls which logos appear in the Step 2 gallery:
...
const PREVIEWS = [
  ...
  // 6 — APR (small circular badge — logomark only)
  { num: 6, id: 'apr', logoType: 'logomark', label: 'APR', defaults: { title: 'Annual Percentage Rate', subtitle: 'Aptos - 7.44%', partnerLogo: 'aptos.png' } },
  ...
  // 13 — Dark Full (small icon spot — logomark)
  { num: 13, id: 'template-10', logoType: 'logomark', label: 'Dark Full', defaults: { title: 'Monad fee change', partnerLogo: 'monad.svg' } },
  // 14 — Collaboration 3 Companies (Light) — three circular slots → logomark
  { num: 14, id: 'template-11', logoType: 'logomark', label: 'Collaboration 3 Companies (Light)', defaults: { title: 'mEVUSD: Regulatory-Compliant Tokenized Strategy', subtitle: 'Targeting 7–12% APY', partnerLogo1: 'collab3-logo1.svg', partnerLogo2: 'collab3-logo2.svg', partnerLogo3: 'collab3-logo3.svg' } },
  // 15 — Collaboration 3 Companies (Dark) — same as 14
  { num: 15, id: 'template-12', logoType: 'logomark', label: 'Collaboration 3 Companies (Dark)', defaults: { title: 'mEVUSD: Regulatory-Compliant Tokenized Strategy', subtitle: 'Targeting 7–12% APY', partnerLogo1: 'collab3-logo1.svg', partnerLogo2: 'collab3-logo2.svg', partnerLogo3: 'collab3-logo3.svg' } },
  ...
  // 18 — Dark Text Left + Icon Right (small icon spot — logomark)
  { num: 18, id: 'template-15', logoType: 'logomark', label: 'Dark Text Left + Icon Right', defaults: { title: 'Everstake ICON Validator Will Close After Phase 3', subtitle: 'Network Shrinkage — Mar 23, 2026', partnerLogo: 'icon-network.svg' } },
